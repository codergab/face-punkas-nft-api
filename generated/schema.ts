...
export class Token extends Entity {
  constructor(id: string) {
    ...
    this.set("updateAtTimestamp", Value.fromBigInt(BigInt.zero()));
  ...
  get updateAtTimestamp(): BigInt {
    let value = this.get("updateAtTimestamp");
    return value!.toBigInt();
  }

  set updateAtTimestamp(value: BigInt) {
    this.set("updateAtTimestamp", Value.fromBigInt(value));
  }
